...
const Login = () => {
  ...
  return (
    <div className="relative min-h-screen">
      ...
      <div className="relative flex flex-col mt-20 md:mx-40 space-y-8 bg-white shadow-2xl rounded-2xl md:flex-row md:space-y-0">
        <div className="flex flex-col justify-center p-8 md:p-16">
          ...
          <span className="mb-2 text-lg font-tertiary font-semibold">Email</span>
          <input
            type="text"
            value={email}
            onChange={(e) => {
            ...
            id="email"
          />
          {errorEmail && <div className="text-yellow-500 mt-2">{errorEmail}</div>}
          <span className="mb-2 text-lg font-tertiary font-semibold">Password</span>
          <input
            type="password"
            value={password}
            onChange={(e) => {
            ...
            id="pass"
          />
          {errorPassword && <div className="text-yellow-500 mt-2">{errorPassword}</div>}
          {/* ... */}
