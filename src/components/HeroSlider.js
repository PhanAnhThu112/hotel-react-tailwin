  ...
  return (
    ...
    >
      {sildes.map((slide, index) => {
        ...
        return (
          <SwiperSlide className="h-full bg-pink-400 relative" key={index}>
            <div className="absolute top-0 w-full h-full">
              <img className="object-cover h-full w-full" src={bg} alt="" />
            </div>
            <div className="absolute w-full h-full bg-black/70"></div>
            <div className="z-20 flex flex-col justify-center items-center text-white text-center absolute top-0 w-full h-full">
